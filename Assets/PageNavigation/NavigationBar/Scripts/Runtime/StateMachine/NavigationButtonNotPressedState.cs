...
{
    public class NavigationButtonNotPressedState : IState
    {
        ...
        public NavigationButtonNotPressedState(Transform textTransform, AnchorUpdater iconAnchorUpdater, RectTransform target, Image pressedBackgroundImage, Vector2 targetMinAnchor, Vector2 targetMaxAnchor, Action onComplete)
        {
